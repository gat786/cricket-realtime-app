...
{{ .Values.teamService.service.name }}
{{- end }}

{{- define "scoreService.serviceName" -}}
{{ .Values.scoreService.service.name }}
{{- end }}

{{- define "teamServiceBeta.labels" -}}
app: team-service
version: beta
{{- end }}

{{- define "teamServiceBeta.serviceName" -}}
{{ .Values.teamService.service.name }}-beta
{{- end }}
